...
COMPFLAGS := -DCOMPRESSOR_RAW -DCOMPRESSOR_RLE -DCOMPRESSOR_PLETTER -DCOMPRESSOR_ZX0
ifndef CXXFLAGS
...
PKGFLAGS = -DMSX2 -DDAADV3 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(COMPFLAGS) --max-allocs-per-node 200000

EN_SC5:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=5 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC6:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=6 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC7:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=7 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC8:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=8 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC10:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=10 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC12:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=12 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC5:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=5 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC6:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=6 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC7:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=7 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC8:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=8 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com"  _package_single
ES_SC10:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=10 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC12:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=12 $(PKGFLAGS)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC8_TR:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_EN -DSCREEN=8 $(PKGFLAGS) -DTRANSCRIPT" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC8_TR:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DLANG_ES -DSCREEN=8 $(PKGFLAGS) -DTRANSCRIPT" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
_package_single:
