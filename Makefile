...
EN_SC5:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_EN -DSCREEN=5 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC6:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_EN -DSCREEN=6 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC7:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_EN -DSCREEN=7 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC8:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_EN -DSCREEN=8 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC10:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_EN -DSCREEN=10 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC12:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_EN -DSCREEN=12 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC5:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_ES -DSCREEN=5 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC6:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_ES -DSCREEN=6 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC7:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_ES -DSCREEN=7 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC8:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_ES -DSCREEN=8 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com"  _package_single
ES_SC10:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_ES -DSCREEN=10 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
ES_SC12:
	$(MAKE) $(MAKEFLAGS) CXXFLAGS="-DMSX2 -DLANG_ES -DSCREEN=12 -DFONTWIDTH=6 -DVERSION=$(VERSION) $(FULLOPT)" OUTFILE="msx2daad_$(VERSION)_$@.com" _package_single
EN_SC8_TR:
